...
# `test_finalize_runs_memory_bridge_over_the_handoff_dir` (a lambda in place
# of the bridge) graduated in plan-5 task 5.3 to
# tests/test_memory_bridge.py::test_finalize_save_state_bridges_the_handoff_dir_for_real
# (real spawned daemon, real ingest) and ::test_finalize_skips_the_bridge_on_sync_false_and_dry_run.
